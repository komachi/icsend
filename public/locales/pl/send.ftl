...
sendYourFilesLink = Wypróbuj icsend
...
notSupportedOutdatedDetail = Ta wersja Firefoksa nie obsługuje technologii internetowej, która napędza icsend. Należy uaktualnić przeglądarkę.
...
javascriptRequired = icsend wymaga języka JavaScript
whyJavascript = Dlaczego icsend wymaga języka JavaScript?
