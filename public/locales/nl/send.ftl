...
sendYourFilesLink = icsend proberen
...
notSupportedOutdatedDetail = Helaas ondersteunt deze versie van Firefox de webtechnologie die icsend gebruikt niet. U dient uw browser bij te werken.
...
javascriptRequired = icsend vereist JavaScript
whyJavascript = Waarom vereist icsend JavaScript?
