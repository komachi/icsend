...
sendYourFilesLink = Experimente o icsend
...
notSupportedOutdatedDetail = Infelizmente essa versão do Firefox não suporta a tecnologia web que faz o icsend funcionar. Você precisa atualizar o seu navegador.
...
javascriptRequired = O icsend requer JavaScript
whyJavascript = Por que o icsend precisa do JavaScript?
