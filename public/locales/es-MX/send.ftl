...
sendYourFilesLink = Prueba icsend
...
notSupportedOutdatedDetail = Lamentablemente esta versión de Firefox no soporta la tecnología web que potencia a icsend. Deberás actualizar tu navegador.
...
whyJavascript = ¿Por qué icsend requiere JavaScript?
