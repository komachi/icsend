...
sendYourFilesLink = Preba icsend
...
notSupportedOutdatedDetail = Esta versión de Firefox no admite la tecnolochía web con que funciona lo icsend. Habrás d'esviellar lo navegador.
...
javascriptRequired = icsend necesita JavaScript
whyJavascript = Per qué icsend necesita JavaScript?
