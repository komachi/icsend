...
sendYourFilesLink = Փորձել icsend-ը
...
notSupportedOutdatedDetail = Դժբախտաբար, Firefox- ի այս տարբերակը չի աջակցում այն վեբ տեխնոլոգիան, որը պետք է icsend-ի համար: Դուք պետք է թարմացնեք ձեր զննարկիչը:
...
javascriptRequired = icsend-ը պահանջում է JavaScript
whyJavascript = Ինչո՞ւ է icsend-ը պահանջում JavaScript.
