...
notSupportedOutdatedDetail = Desafortunadamente esta versión de Firefox nun sofita la teunoloxía web qu'usa icsend. Vas precisar anovar el restolador.
...
javascriptRequired = icsend rique JavaScript
whyJavascript = ¿Por qué icsend rique JavaScript?
