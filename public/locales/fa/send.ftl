...
sendYourFilesLink = icsend را امتحان کنید
...
notSupportedOutdatedDetail = متاسفانه این نسخه از فایرفاکس این تکنولوژی وب که به icsend قدرت می‌بخشد را پشتیبانی نمی‌کند. شما نیاز دارید تا مرورگر خود را بروز کنید.
...
javascriptRequired = icsend نیازمند جاوااسکریپت است
whyJavascript = چرا icsend جاوااسکریپت لازم داد؟
