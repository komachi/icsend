...
sendYourFilesLink = Proveu el icsend
...
notSupportedOutdatedDetail = Aquesta versió del Firefox no admet la tecnologia web amb què funciona el icsend. Haureu d'actualitzar el navegador.
...
javascriptRequired = El icsend necessita JavaScript
whyJavascript = Per què el icsend necessita JavaScript?
