...
sendYourFilesLink = Provoni icsend
...
notSupportedOutdatedDetail = Mjerisht, ky version i Firefox-it nuk e mbulon teknologjinë web mbi të cilën bazohet icsend. Do t’ju duhet të përditësoni shfletuesin tuaj.
...
javascriptRequired = icsend lyp JavaScript
whyJavascript = Ç’i duhet icsend-it JavaScript-i?
