...
sendYourFilesLink = Dùng thử icsend
...
notSupportedOutdatedDetail = Thật không may là phiên bản Firefox này không hỗ trợ công nghệ được sử dụng trong icsend. Bạn cần cập nhật trình duyệt của bạn.
...
javascriptRequired = icsend cần JavaScript
whyJavascript = Tại sao icsend cần JavaScript?
