...
notSupportedOutdatedDetail = Sa kasamaang palad ang bersyon na ito ng Firefox ay hindi sumusuporta sa teknolohiya ng web na nagpapagana ng icsend. Kailangan mong i-update ang iyong browser.
...
javascriptRequired = Nangangailangan ang icsend ng JavaScript
whyJavascript = Bakit ang icsend ay nangangailangan ng JavaScript?
