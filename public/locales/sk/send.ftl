...
sendYourFilesLink = Vyskúšajte icsend
...
notSupportedOutdatedDetail = Žiaľ, táto verzia Firefoxu nepodporuje webovú technológiu, ktorá poháňa icsend. Budete musieť aktualizovať svoj prehliadač.
...
javascriptRequired = icsend vyžaduje JavaScript
whyJavascript = Prečo icsend vyžaduje JavaScript?
