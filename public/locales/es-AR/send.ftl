...
sendYourFilesLink = Probá icsend
...
notSupportedOutdatedDetail = Desafortunadamente esta versión de Firefox no soporta la tecnología web que necesita icsend. Necesitás actualizar el navegador.
...
javascriptRequired = icsend requiere JavaScript
whyJavascript = ¿Por qué icsend requiere Java Script?
