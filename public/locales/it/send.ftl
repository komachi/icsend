...
sendYourFilesLink = Prova icsend
...
notSupportedOutdatedDetail = Purtroppo questa versione di Firefox non supporta le tecnologie web alla base di icsend. È necessario aggiornare il browser.
...
javascriptRequired = icsend richiede JavaScript
whyJavascript = Perché icsend richiede JavaScript?
