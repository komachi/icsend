...
sendYourFilesLink = icsend probearje
...
notSupportedOutdatedDetail = Spitigernôch stipet dizze ferzje fan Firefox de webtechnology dy't icsend mooflik makket net. Jo moatte jo browser fernije.
...
javascriptRequired = icsend fereasket JavaScript.
whyJavascript = Werom hat icsend JavaScript nedich?
