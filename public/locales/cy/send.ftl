...
sendYourFilesLink = Rhowch gynnig ar icsend
...
notSupportedOutdatedDetail = Yn anffodus, nid yw'r fersiwn yma o Firefox yn cynnal y technoleg gwe sy'n gyrru icsend. Bydd angen i chi ddiweddaru eich porwr.
...
javascriptRequired = Mae icsend angen JavaScript
whyJavascript = Pam fod icsend angen JavaScript?
