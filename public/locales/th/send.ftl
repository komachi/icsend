...
sendYourFilesLink = ลองใช้ icsend
...
notSupportedOutdatedDetail = น่าเสียดายที่ Firefox รุ่นนี้ไม่สนับสนุนเทคโนโลยีเว็บที่ขับเคลื่อน icsend คุณจะต้องอัปเดตเบราว์เซอร์ของคุณ
...
javascriptRequired = icsend จำเป็นต้องใช้ JavaScript
whyJavascript = ทำไม icsend จึงจำเป็นต้องใช้ JavaScript?
