...
sendYourFilesLink = Ensajar icsend
...
notSupportedOutdatedDetail = Aquesta version de Firefox es pas compatibla amb la tecnologia web amb la quala fonciona icsend. Vos cal metre a jorn lo navegador.
...
javascriptRequired = icsend requesís JavaScript
whyJavascript = Perque icsend requesís JavaScript ?
