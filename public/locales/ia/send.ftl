...
sendYourFilesLink = Proba icsend
...
notSupportedOutdatedDetail = Infelicemente iste version de Firefox non supporta le nove technologia web que actiona icsend. Tu debe actualisar tu navigator.
...
javascriptRequired = icsend require JavaScript
whyJavascript = Proque icsend require JavaScript?
