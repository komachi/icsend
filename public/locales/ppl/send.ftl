...
sendYourFilesLink = Shikejeku icsend
...
notSupportedOutdatedDetail = Ini tamakalis ipal Firefox tesu kimati ne tzawaltekitilis ne kiyulitia icsend. Nemi pal tikyankwilia ne mutachialuni.
...
javascriptRequired = icsend muneki JavaScript
whyJavascript = Taika icsend muneki JavaScript?
