...
sendYourFilesLink = icsend পরখ করে দেখুন
...
notSupportedOutdatedDetail = দুর্ভাগ্যবশত Firefox এই সংস্করণটি ওয়েব প্রযুক্তিকে সমর্থন করে না যা icsend কে সমর্থন করে। আপনাকে আপনার ব্রাউজারটি আপডেট করতে হবে।
...
javascriptRequired = icsend এর জাভাস্ক্রিপ্ট প্রয়োজন।
whyJavascript = কেন icsend এর জাভাস্ক্রিপ্ট প্রয়োজন?
