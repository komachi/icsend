...
notSupportedOutdatedDetail = Dessverre støtter ikke denne versjonen av Firefox netteknologien som driver icsend. Du trenger å oppdatere nettleseren din.
...
javascriptRequired = icsend krever JavaScript.
whyJavascript = Hvorfor krever icsend JavaScript?
