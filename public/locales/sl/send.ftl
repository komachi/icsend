...
sendYourFilesLink = Preskusite icsend
...
notSupportedOutdatedDetail = Ta brskalnik žal ne podpira tehnologije, na kateri temelji icsend. Svoj brskalnik boste morali posodobiti.
...
javascriptRequired = icsend zahteva JavaScript
whyJavascript = Zakaj icsend zahteva JavaScript?
