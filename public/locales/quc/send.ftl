...
sendYourFilesLink = Chak'amb'ejaj icsend
...
notSupportedOutdatedDetail = Chakuyu' we okib'al rech Firefox man kutoq'aj ta le k'ak'eta'm rech web' le kuya' uchuq'ab' icsend. Rajawaxik kak'ak'arisaj le anik'onel.
...
javascriptRequired = Le icsend kajawataj JavaScript chech
whyJavascript = ¿jasche kajawataj JavaScript chech  icsend?
