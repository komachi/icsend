...
sendYourFilesLink = გამოცადეთ icsend
...
notSupportedOutdatedDetail = სამწუხაროდ, Firefox-ის ამ ვერსიას არ გააჩნია ის ტექნოლოგია, რომელიც აუცილებელია icsend-ის მუშაობისთვის. გესაჭიროებათ, ბრაუზერის განახლება.
...
javascriptRequired = icsend საჭიროებს JavaScript-ს
whyJavascript = რატომ საჭიროებს icsend JavaScript-ს?
