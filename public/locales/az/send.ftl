...
sendYourFilesLink = icsend Yoxla
...
notSupportedOutdatedDetail = Heyf ki, Firefox səyyahının bu versiyası icsend-ə güc verən web texnologiyalarını dəstəkləmir. Səyyahınızı yeniləməlisiniz.
...
javascriptRequired = icsend üçün JavaScript lazımdır
whyJavascript = icsend niyə JavaScript tələb edir?
