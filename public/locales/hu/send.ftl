...
sendYourFilesLink = Próbálja ki a icsendet
...
notSupportedOutdatedDetail = Sajnos a Firefox ezen verziója nem támogatja a icsend alapját képező technológiát. Frissítenie kell a böngészőjét.
...
javascriptRequired = A icsendhez JavaScript szükséges
whyJavascript = Miért van szükség JavaScriptre a icsendhez?
