...
sendYourFilesLink = icsend ausprobieren
...
notSupportedOutdatedDetail = Leider unterstützt diese Firefox-Version die Web-Technologie nicht, auf der icsend basiert. Du musst deinen Browser aktualisieren.
...
javascriptRequired = icsend benötigt JavaScript
whyJavascript = Warum benötigt icsend JavaScript?
