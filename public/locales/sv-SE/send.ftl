...
sendYourFilesLink = Testa icsend
...
notSupportedOutdatedDetail = Tyvärr stödjer den här versionen av Firefox inte webbtekniken som driver icsend. Du måste uppdatera din webbläsare.
...
javascriptRequired = icsend kräver JavaScript
whyJavascript = Varför kräver icsend JavaScript?
