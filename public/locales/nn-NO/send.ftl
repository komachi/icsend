...
notSupportedOutdatedDetail = Dessverre støttar ikkje denne versjonen av Firefox nett-teknologien som driv icsend. Du må å oppdatere nettlesaren din.
...
javascriptRequired = icsend krev JavaScript.
whyJavascript = Kvifor krev icsend JavaScript?
