...
notSupportedOutdatedDetail = 残念ながらお使いのバージョンの Firefox は icsend が活用しているウェブ技術に対応していません。ブラウザーを更新する必要があります。
...
javascriptRequired = icsend を使うには JavaScript が必要です
whyJavascript = icsend が JavaScript を必要とする理由
