...
sendYourFilesLink = Experimentar o icsend
...
notSupportedOutdatedDetail = Infelizmente esta versão do Firefox não suporta a tecnologia web que faz o icsend funcionar. Precisa de atualizar o seu navegador.
...
whyJavascript = Porque é que o icsend requer JavaScript?
