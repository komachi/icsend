...
sendYourFilesLink = Δοκιμάστε το icsend
...
notSupportedOutdatedDetail = Δυστυχώς, αυτή η έκδοση του Firefox δεν υποστηρίζει την τεχνολογία ιστού στην οποία βασίζεται το icsend. Πρέπει να ενημερώσετε το πρόγραμμα περιήγησής σας.
...
javascriptRequired = Το icsend απαιτεί JavaScript
whyJavascript = Γιατί το icsend απαιτεί JavaScript;
