...
sendYourFilesLink = Kokeile icsend -palvelua
...
notSupportedOutdatedDetail = Valitettavasti tämä Firefoxin versio ei tue icsendiä käyttävää web-tekniikkaa. Sinun on päivitettävä selaimesi.
...
whyJavascript = Miksi icsend vaatii JavaScriptin?
