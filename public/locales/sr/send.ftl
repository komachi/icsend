...
sendYourFilesLink = Испробајте icsend
...
notSupportedOutdatedDetail = Нажалост, ово издање Firefox-a не подржава веб технологију која омогућава icsend. Мораћете да ажурирате ваш прегледач.
...
javascriptRequired = За icsend је потребан JavaScript
whyJavascript = Зашто је потребан JavaScript за icsend?
