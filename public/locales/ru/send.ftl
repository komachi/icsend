...
sendYourFilesLink = Попробовать icsend
...
notSupportedOutdatedDetail = К сожалению, эта версия Firefox не поддерживает веб-технологию, благодаря которой работает icsend. Ваш нужно обновить свой браузер.
...
javascriptRequired = Для icsend необходим JavaScript
whyJavascript = Почему icsend требуется JavaScript?
